...
const AnalysePage = () => {
  const [selectedTab, setSelectedTab] = useState<"text" | "image">("text");
    ...
    <div className="flex flex-col items-center p-6 gap-y-6">
      <div className="w-full max-w-[900px] flex flex-col gap-y-4 py-2">
        <h1 className="text-2xl font-bold text-left text-[#3177FF]">
          AI 사기 문자 분석{" "}
          <span className="italic text-base text-[#3177FF]">Beta</span>
        </h1>
      ...
      <div className="w-full max-w-[900px]">
        ...
        <div
          className="w-full max-w-[900px] md:flex-row min-h-[400px] md:min-h-[500px]
      ring-2 ring-blue-200 rounded-lg shadow-sm"
        >
          {selectedTab === "text" ? <TextAnalyse /> : <ImageAnalyse />}
        </div>
      </div>
      <div className="w-full p-4 text-gray-500 text-xs md:text-sm">
        <p>
          ※ 사기 문자 AI 분석은 베타 버전입니다. <br className="md:hidden" />
