...
- 호스팅을 위해 개인 도메인이 필수로 보유하고 있어야 합니다. 다음을 도메인 설정의 DNS 레코드에 설정 바랍니다:
  - api.도메인.com (필수)
  - @.도메인.com (필수)
  - www.도메인.com (선택, 설정 시 nginx의 구성 파일 수정 필수)
...
| 구분 | 라이브러리 / 프로그램 | 라이선스 |
|------|--------------------|-----------|
| **Database** | MySQL (Docker 이미지 기반) | GPL v2 (*컨테이너로 단순 사용은 문제 없음*) |
| **Backend (Node.js)** | Node.js | MIT |
| | cors | MIT |
| | express | MIT |
| | promise-mysql | MIT |
| | axios | MIT |
| | cheerio | MIT |
| | cron | MIT |
| **Frontend (Next.js)** | Next.js | MIT |
| **AI / Python** | Python | PSF License (MIT 계열) |
| | Flask | BSD-3-Clause |
| | Werkzeug.utils | BSD-3-Clause |
| | OpenCV | Apache 2.0 |
| | PyTorch | BSD-3-Clause |
| | Transformers (HuggingFace) | Apache 2.0 |
| **Infra** | Docker / Docker Compose | Apache 2.0 |
